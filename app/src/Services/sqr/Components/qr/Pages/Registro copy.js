...
import { SForm, SHr, SIcon, SNavigation, SPage, SText, SView, SLoad, SButtom, SImage, SInput, STheme } from 'servisofts-component';
...
class Registro extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            colorBackground: "",
            colorBody: STheme.color.secondary,
            colorHeader: STheme.color.secondary,
    ...
    getInputs() {
        return (
            <SView col={"xs-11 sm-10 md-8 lg-6 xl-4"} row>
                ...
                <SInput onChangeText={(val) => { this.setState({ colorBackground2: val }) }} value={this.state.colorBackground2} label={"colorBackground2"} customStyle={"calistenia"} />
                <SInput onChangeText={(val) => { this.setState({ type_color: val }) }} value={this.state.type_color} label={"type_color"} customStyle={"calistenia"} />
                ...
                <SInput onChangeText={(val) => { this.setState({ image_src: val }) }} value={this.state.image_src} label={"image src"} customStyle={"calistenia"} />
